...
export default function StartRating({ maxRating= 5, color= "#fcc419", size= 48, messages=  [], defaultRating= 0 }) {
...
// EMPTY STAR        
    <span role="button" style={starStyle} onClick={onRate} onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}>
        {full ? (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill={color} stroke="#000" >
